...
WB_DETAIL_URL = os.getenv("WB_DETAIL_URL", "https://www.wildberries.ru/__internal/card/cards/v4/detail")
...
WB_FORBIDDEN_THRESHOLD = int(os.getenv("WB_FORBIDDEN_THRESHOLD", "5"))
WB_CIRCUIT_COOLDOWN = int(os.getenv("WB_CIRCUIT_COOLDOWN", "60"))

BATCH_SIZE = int(os.getenv("BATCH_SIZE", "100"))
CONCURRENT_REQUESTS_LIMIT = int(os.getenv("CONCURRENT_REQUESTS_LIMIT", "10"))
MIN_CONCURRENT_REQUESTS_LIMIT = int(os.getenv("MIN_CONCURRENT_REQUESTS_LIMIT", "3"))
